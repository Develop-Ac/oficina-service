...
async function bootstrap() {
  ...
  if (process.env.SWAGGER_ENABLED === 'true') {
    const config = new DocumentBuilder()
      .setTitle('Oficina Service API')
      .setDescription(`
      API do serviço de oficina da AC Acessórios

      ## Funcionalidades principais:
      - **Checklists**: Gerenciamento de checklists de veículos
      - **Ordens de Serviço**: Criação e acompanhamento de ordens de serviço
      - **Uploads**: Envio e gerenciamento de arquivos relacionados à oficina
